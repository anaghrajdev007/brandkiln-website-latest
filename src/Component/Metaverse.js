...
import Topbrands2 from '../Images/image2.png'
import Topbrands3 from '../Images/image3.png'
...
const Metaverse = () => {
    ...
    const faqData = [
        ...
        {
            id: 2,
            question: "Experience Innovation",
        ...
        <>
            <section className='about-faq-section-new'>
                <div className=''>
                    ...
                    <div className='bluetitel'>Metaverse</div>
                    ...
                    <div className='bluebigobutton mt-3'>Engage us for creating your Metaverse presence</div>
                            ...
                            <div key={faq.id}>
                                <h2 onClick={() => toggleAnswer(index)}>
                                    <svg
                                        ...
                                        className={activeIndex === index ? "rotate-icon" : "mainsvg"}
                                    >
                                    ...
                                    <span className='main-textpink'>{faq.question}</span>
                                </h2>
                    ...
                    <div className='text-styles mt-5 mb-5'>Read Next  <span>: e -Training</span> <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
